...
namespace CmsShoppingCart.Areas.Admin.Controllers
{
    ...
    public class ShopController : Controller
    {
        ...
        {
            List<UserForAdminVM> usersList = new List<UserForAdminVM>();
            ...
            using (Db db = new Db())
            {
                ...
                {
                    UserRoleDTO userroles = db.UserRoles.Where(x => x.UserId == user.Id).FirstOrDefault();
                    ...
                    usersList.Add(new UserForAdminVM()
                    {
                        Id = user.Id,
